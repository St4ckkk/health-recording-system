            ...
            <div class="content-wrapper">
                <section class="p-6">
                    <div class="mb-4 flex justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">Transaction Records</h2>
                            <p class="text-sm text-gray-500">
                                View and manage all medicine transactions.
                            </p>
                        </div>
                        <div class="flex space-x-2">
                            ...
                            <button
                                class="add-transaction-btn px-4 py-2 admin-primary rounded-md text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200">
                                <i class='bx bx-plus mr-1'></i> New Transaction
                            </button>
                        </div>
                    </div>
                        ...
                        function viewTransaction(id) {
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">${new Date(transaction.transaction_date).toLocaleDateString()}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500">Medicine</p>
                                    <p class="font-medium">${transaction.medicine_name}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">₱${parseFloat(transaction.unit_price).toFixed(2)}</p>
                                </div>
                                <div>
                                    <p class="text-sm text-gray-500">Total Amount</p>
                                    <p class="font-medium">₱${parseFloat(transaction.total_amount).toFixed(2)}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="font-medium">${transaction.supplier}</p>
                                </div>` : ''}
                                ${transaction.patient_id ? `
                                <div>
                                    <p class="text-sm text-gray-500">Patient ID</p>
                                    <p class="font-medium">${transaction.patient_id}</p>
                                </div>` : ''}
                                ${transaction.remarks ? `
                                <div class="col-span-2">
                                    <p class="text-sm text-gray-500">Remarks</p>
                                    <p class="font-medium">${transaction.remarks}</p>
                                </div>` : ''}
                            </div>
                        `;
                                    } else {
