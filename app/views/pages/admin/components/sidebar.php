...
<nav class="p-4 sidebar border border-gray-200">
    <div class="p-4 mb-6 bg-blue-600 rounded-lg">
        <div class="flex items-center">
            ...
            <div class="ml-3 text-white">
                ...
                <div class="text-xs">Admin Portal</div>
            </div>
        </div>
    </div>
        ...
        <ul class="space-y-md">
            <a href="<?= BASE_URL ?>/admin/dashboard">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/admin/dashboard') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/staff">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/admin/staff') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
            ...
            <a href="<?= BASE_URL ?>/admin/reports">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    ...
                    <i class='bx bx-chart text-lg mr-2 ml-1'></i> Reports
                </li>
            </a>
            <a href="<?= BASE_URL ?>/admin/notification">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1"
                    style="<?php echo strpos($request_uri, '/admin/notification') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
    ...
    <div class="logout-container mt-auto">
        <button id="sidebarLogoutBtn"
            class="px-sm py-2 rounded-md hover:bg-blue-600 flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 hover:text-white w-full">
