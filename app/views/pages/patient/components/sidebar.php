...
<nav class="p-4 sidebar border border-gray-200">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3 text-white">
                <div class="text-lg font-semibold flex items-center">
                    <i class='bx bx-pulse mr-2'></i>TeleCure
                </div>
                <div class="text-xs opacity-80">Patient Portal</div>
            </div>
        </div>
    </div>
    <div class="sidebar-content">
        <ul class="space-y-md">
            <a href="<?= BASE_URL ?>/patient/dashboard">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/patient/dashboard') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
                    <i class='bx bx-home text-lg mr-2 ml-1'></i> Dashboard
                </li>
            </a>

            <a href="<?= BASE_URL ?>/patient/vitals">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/patient/vitals') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
                    <i class='bx bx-heart-pulse text-lg mr-2 ml-1'></i> Vital Signs
                </li>
            </a>

            <a href="<?= BASE_URL ?>/patient/medications">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/patient/medications') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
                    <i class='bx bx-capsule text-lg mr-2 ml-1'></i> Medications
                </li>
            </a>

            <a href="<?= BASE_URL ?>/patient/reports">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/patient/reports') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
                    <i class='bx bx-file text-lg mr-2 ml-1'></i> Reports
                </li>
            </a>

            <a href="<?= BASE_URL ?>/patient/notification">
                <li class="px-sm py-2 rounded-md hover:bg-blue-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1"
                    style="<?php echo strpos($request_uri, '/patient/notification') !== false ? 'background-color: rgb(37 99 235); color: white;' : ''; ?>">
                    <i class='bx bx-bell text-lg mr-2 ml-1'></i>
                    <div class="flex items-center">
                        Notifications
                        <?php if ($notification_count > 0): ?>
                            <span class="ml-2 inline-flex items-center justify-center px-1.5 py-0.6 text-xs font-medium text-white bg-gray-900 rounded">
    ...
    <div class="logout-container mt-auto">
        <button id="sidebarLogoutBtn"
            class="px-sm py-2 rounded-md hover:bg-blue-600 flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 hover:text-white">
