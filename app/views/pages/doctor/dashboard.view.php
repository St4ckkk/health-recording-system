                            ...
                            <div class="bg-white rounded-lg p-6 flex-1 shadow-sm border border-gray-100 fade-in">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <h3 class="text-2xl font-semibold mt-1">1,284</h3>
                                        <p class="text-green-500 text-xs mt-1">+2.1% from last month</p>
                                    </div>
                            ...
                            <div class="bg-white rounded-lg p-6 flex-1 shadow-sm border border-gray-100 fade-in">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs mt-1">2 urgent consultations</p>
                                    </div>
                            ...
                            <div class="bg-white rounded-lg p-6 flex-1 shadow-sm border border-gray-100 fade-in">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs mt-1">Low stock items</p>
                                    </div>
