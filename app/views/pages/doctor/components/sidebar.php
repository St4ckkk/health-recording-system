    ...
    <div class="sidebar-content">
        <ul class="space-y-md">
            ...
            <a href="<?= BASE_URL ?>/doctor/reports">
                <li class="px-sm py-2 rounded-md hover:bg-green-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo (strpos($request_uri, '/doctor/reports') !== false || strpos($request_uri, '/doctor/reports') !== false) ? 'background-color: rgb(22 163 74); color: white;' : ''; ?>">
            ...
            <a href="<?= BASE_URL ?>/doctor/appointments">
                <li class="px-sm py-2 rounded-md hover:bg-green-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/doctor/appointments') !== false ? 'background-color: rgb(22 163 74); color: white;' : ''; ?>">
