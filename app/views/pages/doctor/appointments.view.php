            ...
            <div class="content-wrapper">
                <section id="appointmentsView" class="p-6 view-transition visible-view">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-500">Manage and view your appointments.</p>
                    </div>
                                    ...
                                    <?php if (!empty($appointments)): ?>
                                        <?php foreach ($appointments as $appointment): ?>
                                            <tr class="border-b border-gray-200">
                                                <td class="py-3 px-4">
                                                    <div class="flex flex-col">
                                                        ...
                                                        <span class="text-xs text-gray-500">
                                                            <?= htmlspecialchars($appointment->tracking_number) ?>
                                                        </span>
                                                    </div>
                                                </td>
                                                <td class="py-3 px-4">
                                                ...
                                                <!-- Update the appointment type badge -->
                                                <td class="py-3 px-4">
                                                    <?php
                                                    $typeClass = '';
                                                    switch (strtolower($appointment->appointment_type)) {
                                                        case 'check-up':
                                                        ...
                                                        case 'emergency':
                                                            ...
                                                            break;
                                                        default:
                                                            $typeClass = 'bg-gray-50 text-gray-700';
                                                    }
                                                    ?>
                                                    <span class="appointment-type <?= $typeClass ?>">
                                                        <?= htmlspecialchars($appointment->appointment_type) ?>
                                                    </span>
                                                </td>

                                                <td class="py-3 px-4">
                                                    <span class="max-w-reason text-sm text-gray-500">
                                                    ...
                                                    <div class="action-buttons-container">
                                                        <div class="tooltip">
                                                            <button class="p-2 text-blue-600 hover:text-blue-800"
                                                                onclick="window.location.href='<?= BASE_URL ?>/doctor/checkup/?id=<?= $appointment->patient_id ?>'"
                                                                data-appointment-id="<?= htmlspecialchars($appointment->id) ?>">
                                                                <i class="bx bx-plus-medical text-lg"></i>
                                                                <span class="tooltip-text">Start Check-up</span>
                                                            </button>
                                                        </div>
                                                        <div class="tooltip">
                                                            <button class="p-2 text-yellow-600 hover:text-yellow-800"
                                                                onclick="window.location.href='<?= BASE_URL ?>/doctor/patientView/?id=<?= $appointment->patient_id ?>'"
                                                                data-appointment-id="<?= htmlspecialchars($appointment->id) ?>">
                                                                <i class="bx bx-user text-lg"></i>
                                                                <span class="tooltip-text">View Patient</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function filterPatients() {
            ...
            document.querySelectorAll('.appointments-table tbody tr').forEach(row => {
                ...
                const patientCell = row.querySelector('td:first-child');
                ...
                const matchesSearch = patientInfo.includes(searchTerm);
