...
<body class="font-body">
    ...
    <!-- Include Add Medicine Modal -->
    <?php include(VIEW_ROOT . '/pages/pharmacist/components/modals/add-medicine.php') ?>

    <!-- Dispense Modal -->
    <div id="dispenseModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-6 w-full max-w-md">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-bold">Dispense Medicine</h3>
                <button onclick="closeDispenseModal()" class="text-gray-500 hover:text-gray-700">
                    <i class="bx bx-x text-2xl"></i>
                </button>
            </div>
            <form id="dispenseForm" action="<?= BASE_URL ?>/doctor/dispenseMedicine" method="POST">
                <input type="hidden" id="medicineId" name="medicine_id">

                <div class="mb-4">
                    <label for="medicineName" class="block text-sm font-medium text-gray-700 mb-1">Medicine</label>
                    <input type="text" id="medicineName"
                        class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100" readonly>
                </div>

                <div class="mb-4">
                    <label for="quantity" class="block text-sm font-medium text-gray-700 mb-1">Quantity to
                        Dispense</label>
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="closeDispenseModal()"
                        class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 mr-2">Cancel</button>
                    <button type="submit"
                        class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Dispense</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        // Update the Add Medicine button click handler
        ...
        document.getElementById('addMedicineForm').addEventListener('submit', function (e) {
            ...
            // You can use FormData to collect the form data
            const formData = new FormData(this);
            // Add your AJAX call or form processing here
        });
    </script>
</body>
