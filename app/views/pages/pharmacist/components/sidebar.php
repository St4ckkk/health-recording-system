    ...
    <div class="p-4 mb-6 bg-purple-600 rounded-lg">
        <div class="flex items-center">
            ...
            <div class="ml-3 text-white">
                ...
                <div class="text-xs">Pharmacist Portal</div>
            </div>
        </div>
    </div>
    <div class="sidebar-content">
        <ul class="space-y-md">
            <a href="<?= BASE_URL ?>/pharmacist/dashboard">
                <li class="px-sm py-2 rounded-md hover:bg-purple-600 hover:text-white flex items-center cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/pharmacist/dashboard') !== false ? 'background-color: rgb(147 51 234); color: white;' : ''; ?>">
            ...
            <a href="<?= BASE_URL ?>/pharmacist/reports">
                <li class="px-sm py-2 rounded-md hover:bg-purple-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1 mb-2"
                    style="<?php echo strpos($request_uri, '/pharmacist/reports') !== false ? 'background-color: rgb(147 51 234); color: white;' : ''; ?>">
                    <i class='bx bx-chart text-lg mr-2 ml-1'></i> Reports
                </li>
            </a>

            <a href="<?= BASE_URL ?>/pharmacist/notification">
                <li class="px-sm py-2 rounded-md hover:bg-purple-600 hover:text-white flex items-center text-gray-900 cursor-pointer transition-all duration-200 hover:translate-x-1"
                    style="<?php echo strpos($request_uri, '/pharmacist/notification') !== false ? 'background-color: rgb(147 51 234); color: white;' : ''; ?>">
