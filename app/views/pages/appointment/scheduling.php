    ...
    <div class="flex flex-col md:flex-row w-full bg-white max-w-6xl card">
        ...
        <div class="w-full md:w-2/5 p-8 border-b md:border-b-0 md:border-r border-gray-200 bg-gray-50">
            <div class="mb-8">  
                ...
                <div id="selectedAppointmentTime" class="hidden mt-8 p-4 rounded-lg bg-primary-light border border-primary/10">
        ...
        <div class="w-full md:w-3/5 p-8 relative">
                ...
                <div class="flex flex-col md:flex-row md:space-x-8">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button id="nextMonth" class="w-10 h-10 flex items-center justify-center rounded-full bg-primary-light text-primary transition-colors">
            ...
            <div id="patientFormView" class="hidden fade-in">
                <div class="flex items-center mb-6">
                    <button id="backToCalendar" class="flex items-center text-primary hover:text-primary-dark transition-colors">
                ...
                <form id="patientForm" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="appointmentReason" name="appointmentReason" required rows="3" class="form-input w-full"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="legalSex" class="block text-sm font-medium text-gray-700 mb-1">Legal Sex*</label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="address" name="address" required rows="3" class="form-input w-full"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" id="isGuardian" name="isGuardian" class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded">
                            <label for="isGuardian" class="ml-2 block text-sm text-gray-700">I am not the patient (booking for someone else)</label>
                        </div>
                        ...
                        <div id="guardianFields" class="hidden space-y-4 fade-in">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="relationship" class="block text-sm font-medium text-gray-700 mb-1">Relationship to Patient*</label>
