...
<body class="min-h-screen flex items-center justify-center p-4 bg-gray-50">
  <div class="w-full max-w-2xl">
      <div class="w-64 h-16 mb-8 mx-auto">
      ...
      <div class="bg-white shadow-md rounded-lg p-8 text-center">
          <!-- Booking icon with pending status -->
          ...
          <p class="text-gray-600 mb-6">Your appointment has been successfully booked and is waiting for confirmation.</p>
          ...
          <div class="bg-gray-50 rounded-lg p-6 text-left mb-6">
              ...
              <div class="info-row">
                  ...
                  <div class="info-value">Dr. <?= isset($doctor->full_name) ? $doctor->full_name : 'Unknown' ?></div>
              </div>

              <div class="info-row">
                  <div class="info-label">Specialty</div>
                  <div class="info-value"><?= isset($doctor->specialization) ? $doctor->specialization : 'Not specified' ?></div>
              </div>

              <div class="info-row">
                  <div class="info-label">Date</div>
                  <div class="info-value"><?= date('l, F j, Y', strtotime($appointment->appointment_date)) ?></div>
              </div>
              ...
              <div class="info-row">
                  ...
                  <div class="info-value"><?= isset($patient) ? $patient->first_name . ' ' . $patient->last_name : 'Unknown Patient' ?></div>
              </div>
      ...
      <div class="mt-6 text-center space-y-2">
          <div class="bg-blue-50 text-blue-700 p-4 rounded-lg text-sm">
              ...
              <p class="mt-1">Our staff will review your appointment request and confirm it shortly. You'll receive a confirmation email once approved.</p>
          </div>
          <p class="text-sm text-gray-500">If you have any questions, please contact us at support@testclinic.com</p>
      </div>
  </div>
</body>
