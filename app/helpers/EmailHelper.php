...
class EmailHelper
{
    ...
    public function sendAppointmentReminder($recipientEmail, $recipientName, $template, $data)
    {
        try {
            ...
            // Enable debug output for troubleshooting if needed
    ...
    private function getStandardReminderTemplate($data)
    {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
            <div style="text-align: center; margin-bottom: 20px;">
                <h2 style="color: #4a5568; margin-bottom: 5px;">Appointment Reminder</h2>
                <p style="color: #718096; margin-top: 0;">Your upcoming appointment details</p>
            </div>
            
            <div style="background-color: #f7fafc; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
                <p style="margin: 5px 0;">Dear ' . $data['patient_name'] . ',</p>
                <p style="margin: 10px 0;">This is a friendly reminder about your upcoming appointment with ' . $data['doctor_name'] . '.</p>
            </div>
            
            <div style="margin-bottom: 20px;">
                <h3 style="color: #4a5568; font-size: 16px; margin-bottom: 10px;">Appointment Details:</h3>
                <p style="margin: 5px 0;"><strong>Date:</strong> ' . $data['appointment_date'] . '</p>
                <p style="margin: 5px 0;"><strong>Time:</strong> ' . $data['appointment_time'] . '</p>
                <p style="margin: 5px 0;"><strong>Doctor:</strong> ' . $data['doctor_name'] . '</p>
                <p style="margin: 5px 0;"><strong>Type:</strong> ' . $data['appointment_type'] . '</p>
                <p style="margin: 5px 0;"><strong>Tracking Number:</strong> ' . $data['tracking_number'] . '</p>
            </div>
            
            ' . (!empty($data['additional_message']) ? '<div style="margin-bottom: 20px; padding: 10px; background-color: #ebf8ff; border-radius: 5px;">
                <p style="margin: 5px 0; color: #2b6cb0;"><strong>Additional Information:</strong></p>
                <p style="margin: 5px 0; color: #2c5282;">' . nl2br($data['additional_message']) . '</p>
            </div>' : '') . '
            
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #718096;">
                <p style="margin: 5px 0;">If you need to reschedule or cancel your appointment, please contact us as soon as possible.</p>
                <p style="margin: 5px 0;">' . $data['clinic_name'] . '</p>
                <p style="margin: 5px 0;">' . $data['clinic_address'] . '</p>
                <p style="margin: 5px 0;">Phone: ' . $data['clinic_phone'] . '</p>
            </div>
        </div>';
    }
    ...
    private function getDetailedReminderTemplate($data)
    {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
            ...
            <div style="margin-bottom: 20px;">
                <h3 style="color: #4a5568; font-size: 16px; margin-bottom: 10px;">Preparation Instructions:</h3>
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #718096;">
                <p style="margin: 5px 0;">If you need to reschedule or cancel your appointment, please contact us at least 24 hours in advance.</p>
                <p style="margin: 5px 0;">' . $data['clinic_name'] . '</p>
                <p style="margin: 5px 0;">' . $data['clinic_address'] . '</p>
                <p style="margin: 5px 0;">Phone: ' . $data['clinic_phone'] . '</p>
            </div>
