document.addEventListener('DOMContentLoaded', function () {
    ...
    confirmReschedule.addEventListener('click', function () {
        ...
        formData.append('new_date', selectedCalendarDate.toISOString().split('T')[0]);
